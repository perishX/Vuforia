...
GLuint
GLUtils::initShader(GLenum shaderType, const char* source)
{
...
GLuint
GLUtils::createProgramFromBuffer(const char* vertexShaderBuffer, const char* fragmentShaderBuffer)
{
...
GLuint
GLUtils::createTexture(const VuImageInfo& image)
{
    ...
    GLUtils::checkGlError("Creating texture from image");
...
GLuint
GLUtils::createTexture(int width, int height, unsigned char* data, GLenum format)
{
...
bool
GLUtils::destroyTexture(GLuint textureId)
{
    glDeleteTextures(1, &textureId);
    GLUtils::checkGlError("After glDeleteTextures");
